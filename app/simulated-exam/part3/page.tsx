    ...
    <div className="min-h-screen bg-gray-50 py-8">
      <div className="container mx-auto px-4">
        <header className="mb-6">
          <h1 className="text-2xl font-bold text-primary">Part 3: Representation Exam</h1>
        ...
        <div className="bg-white rounded-lg shadow-md p-6 mb-6">
          ...
          <div className="mb-8">
            <h2 className="text-lg font-medium text-gray-800 mb-4">
              Under Circular 230, which of the following statements is TRUE regarding a practitioner's duty when their client has not complied with US tax laws?
            </h2>
            ...
            <div className="space-y-3 mt-5">
              <div className="flex items-center p-3 border border-gray-200 rounded-md hover:bg-blue-50 cursor-pointer transition-colors">
                ...
                <label htmlFor="answer-a" className="cursor-pointer w-full">The practitioner must immediately terminate the relationship with the client.</label>
              </div>
              <div className="flex items-center p-3 border border-gray-200 rounded-md hover:bg-blue-50 cursor-pointer transition-colors">
                <input type="radio" name="answer" id="answer-b" className="mr-3" />
                <label htmlFor="answer-b" className="cursor-pointer w-full">The practitioner must inform the IRS of the client's noncompliance.</label>
              </div>
              <div className="flex items-center p-3 border border-gray-200 rounded-md hover:bg-blue-50 cursor-pointer transition-colors">
                <input type="radio" name="answer" id="answer-c" className="mr-3" />
                <label htmlFor="answer-c" className="cursor-pointer w-full">The practitioner must advise the client of the noncompliance and the consequences of such noncompliance.</label>
              </div>
              <div className="flex items-center p-3 border border-gray-200 rounded-md hover:bg-blue-50 cursor-pointer transition-colors">
                <input type="radio" name="answer" id="answer-d" className="mr-3" />
                <label htmlFor="answer-d" className="cursor-pointer w-full">The practitioner has no responsibility once tax returns have been filed.</label>
              </div>
            </div>
          </div>
