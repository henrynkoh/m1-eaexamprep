...
const mockQuestions = Array.from({ length: 100 }, (_, index) => ({
  id: index + 1,
  text: `Question ${index + 1}: This is a sample question about business taxation.`,
  options: [
...
export default function SimulatedExamPart2Page() {
      ...
      <div className="container mx-auto px-4">
        <header className="mb-8">
          <div className="flex items-center gap-2 mb-1">
            ...
            <span className="text-gray-700">Part 2: Businesses</span>
          </div>
          <h1 className="text-3xl font-bold text-blue-600">Part 2: Businesses Exam</h1>
