...
const mockQuestions = Array.from({ length: 100 }, (_, index) => ({
  id: index + 1,
  text: `Question ${index + 1}: This is a sample question about individual taxation.`,
  options: [
      ...
      <div className="container mx-auto px-4">
        <header className="mb-8">
          <div className="flex items-center gap-2 mb-1">
            ...
            <span className="text-gray-700">Part 1: Individuals</span>
          </div>
          <h1 className="text-3xl font-bold text-blue-600">Part 1: Individuals Exam</h1>
